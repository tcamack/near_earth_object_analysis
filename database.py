...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        for approach in self._approaches:
            if approach._designation in self._pdes_to_index.keys():
                approach.neo = self._neos[self._pdes_to_index[approach._designation]]
                self._neos[self._pdes_to_index[approach._designation]].approaches.append(approach)
