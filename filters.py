...
class AttributeFilter:
    ...
    def __repr__(self):
        """Printable representation of the AttributeFilter class formatted as an f-string."""
        return f"{self.__class__.__name__}(op=operator.{self.op.__name__}, value={self.value})"


class DateFilter(AttributeFilter):
    """Subclass of AttributeFilter to filter approach objects by date."""
...
class DiameterFilter(AttributeFilter):
    ...
    @classmethod
    def get(cls, approach):
        """Return the diameter of the neo asigned to the CloseApproach object for the diameter filter.
...
class HazardousFilter(AttributeFilter):
    """Subclass of AttributeFilter to filter approach objects by whether or not they're hazardous."""

    @classmethod
    def get(cls, approach):
        """Return the hazardous attribute of the neo assigned to the CloseApproach object for the hazardous filter.

        Args:
            approach(CloseApproach): A CloseApproach object.
        Returns:
            [bool]: Returns the hazardous attribute of a NearEarthObject object.
        """
